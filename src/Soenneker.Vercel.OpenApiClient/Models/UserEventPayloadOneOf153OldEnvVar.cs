...
namespace Soenneker.Vercel.OpenApiClient.Models
{
    ...
    public partial class UserEventPayloadOneOf153OldEnvVar : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf153OldEnvVarTargetItem?>? Target { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf153OldEnvVarTargetItem?> Target { get; set; }
#endif
        /// <summary>The type of this cosmos doc instance, if blank, assume secret.</summary>
        public global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf153OldEnvVarType? Type { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf153OldEnvVar"/> and sets the default values.
        /// </summary>
        public UserEventPayloadOneOf153OldEnvVar()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf153OldEnvVar"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf153OldEnvVar CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf153OldEnvVar();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "target", n => { Target = n.GetCollectionOfEnumValues<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf153OldEnvVarTargetItem>()?.AsList(); } },
                { "type", n => { Type = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf153OldEnvVarType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf153OldEnvVarTargetItem>("target", Target);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf153OldEnvVarType>("type", Type);
