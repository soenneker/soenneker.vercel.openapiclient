...
#nullable restore
        ...
        public global::Soenneker.Vercel.OpenApiClient.Models.GetConfigurations200ResponseOneOf1ItemSource? Source { get; set; }
        /// <summary>The configuration status. Optional. If not defined, assume &apos;ready&apos;.</summary>
        public global::Soenneker.Vercel.OpenApiClient.Models.GetConfigurations200ResponseOneOf1ItemStatus? Status { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Vercel.OpenApiClient.Models.GetConfigurations200ResponseOneOf1Item"/> and sets the default values.
        /// </summary>
        public GetConfigurations200ResponseOneOf1Item()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.Models.GetConfigurations200ResponseOneOf1Item"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Vercel.OpenApiClient.Models.GetConfigurations200ResponseOneOf1Item CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.Models.GetConfigurations200ResponseOneOf1Item();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "disabledReason", n => { DisabledReason = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.GetConfigurations200ResponseOneOf1ItemDisabledReason>(); } },
                { "externalId", n => { ExternalId = n.GetStringValue(); } },
                { "id", n => { Id = n.GetStringValue(); } },
                { "installationType", n => { InstallationType = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.GetConfigurations200ResponseOneOf1ItemInstallationType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.GetConfigurations200ResponseOneOf1ItemDisabledReason>("disabledReason", DisabledReason);
            writer.WriteStringValue("externalId", ExternalId);
            writer.WriteStringValue("id", Id);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.GetConfigurations200ResponseOneOf1ItemInstallationType>("installationType", InstallationType);
