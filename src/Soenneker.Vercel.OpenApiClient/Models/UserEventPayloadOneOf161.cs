...
#nullable restore
        ...
        public global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf161FailureStage? FailureStage { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf161Outcome? Outcome { get; set; }
        /// <summary>The provider property</summary>
        public global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf161Provider? Provider { get; set; }
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "failureStage", n => { FailureStage = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf161FailureStage>(); } },
                { "installationId", n => { InstallationId = n.GetStringValue(); } },
                { "outcome", n => { Outcome = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf161Outcome>(); } },
                { "provider", n => { Provider = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf161Provider>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf161FailureStage>("failureStage", FailureStage);
            writer.WriteStringValue("installationId", InstallationId);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf161Outcome>("outcome", Outcome);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf161Provider>("provider", Provider);
