...
namespace Soenneker.Vercel.OpenApiClient.Models
{
    ...
    public partial class UserEventPayloadOneOf135NewEnvVar : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf135NewEnvVarTargetItem?>? Target { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf135NewEnvVarTargetItem?> Target { get; set; }
#endif
        /// <summary>The type of this cosmos doc instance, if blank, assume secret.</summary>
        public global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf135NewEnvVarType? Type { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf135NewEnvVar"/> and sets the default values.
        /// </summary>
        public UserEventPayloadOneOf135NewEnvVar()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf135NewEnvVar"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf135NewEnvVar CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf135NewEnvVar();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "target", n => { Target = n.GetCollectionOfEnumValues<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf135NewEnvVarTargetItem>()?.AsList(); } },
                { "type", n => { Type = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf135NewEnvVarType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf135NewEnvVarTargetItem>("target", Target);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf135NewEnvVarType>("type", Type);
