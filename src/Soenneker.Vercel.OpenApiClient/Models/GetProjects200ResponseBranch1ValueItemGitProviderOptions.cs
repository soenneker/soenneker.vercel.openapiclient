...
namespace Soenneker.Vercel.OpenApiClient.Models
{
    ...
    public partial class GetProjects200ResponseBranch1ValueItemGitProviderOptions : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        /// </summary>
        public GetProjects200ResponseBranch1ValueItemGitProviderOptions()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.Models.GetProjects200ResponseBranch1ValueItemGitProviderOptions"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Vercel.OpenApiClient.Models.GetProjects200ResponseBranch1ValueItemGitProviderOptions CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.Models.GetProjects200ResponseBranch1ValueItemGitProviderOptions();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "consolidatedGitCommitStatus", n => { ConsolidatedGitCommitStatus = n.GetObjectValue<global::Soenneker.Vercel.OpenApiClient.Models.GetProjects200ResponseBranch1ValueItemGitProviderOptionsConsolidatedGitCommitStatus>(global::Soenneker.Vercel.OpenApiClient.Models.GetProjects200ResponseBranch1ValueItemGitProviderOptionsConsolidatedGitCommitStatus.CreateFromDiscriminatorValue); } },
                { "createDeployments", n => { CreateDeployments = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.GetProjects200ResponseBranch1ValueItemGitProviderOptionsCreateDeployments>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Vercel.OpenApiClient.Models.GetProjects200ResponseBranch1ValueItemGitProviderOptionsConsolidatedGitCommitStatus>("consolidatedGitCommitStatus", ConsolidatedGitCommitStatus);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.GetProjects200ResponseBranch1ValueItemGitProviderOptionsCreateDeployments>("createDeployments", CreateDeployments);
