...
namespace Soenneker.Vercel.OpenApiClient.Models
{
    ...
    public partial class Flag_experiment : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Vercel.OpenApiClient.Models.Flag_experiment_guardrailMetrics>? GuardrailMetrics { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Vercel.OpenApiClient.Models.Flag_experiment_guardrailMetrics> GuardrailMetrics { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Vercel.OpenApiClient.Models.Flag_experiment_primaryMetrics>? PrimaryMetrics { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Vercel.OpenApiClient.Models.Flag_experiment_primaryMetrics> PrimaryMetrics { get; set; }
#endif
        ...
        public global::Soenneker.Vercel.OpenApiClient.Models.Flag_experiment_status? Status { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Vercel.OpenApiClient.Models.Flag_experiment"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.Models.Flag_experiment"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Vercel.OpenApiClient.Models.Flag_experiment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.Models.Flag_experiment();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "primaryMetrics", n => { PrimaryMetrics = n.GetCollectionOfObjectValues<global::Soenneker.Vercel.OpenApiClient.Models.Flag_experiment_primaryMetrics>(global::Soenneker.Vercel.OpenApiClient.Models.Flag_experiment_primaryMetrics.CreateFromDiscriminatorValue)?.AsList(); } },
                { "startedAt", n => { StartedAt = n.GetDoubleValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.Flag_experiment_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Vercel.OpenApiClient.Models.Flag_experiment_primaryMetrics>("primaryMetrics", PrimaryMetrics);
            writer.WriteDoubleValue("startedAt", StartedAt);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.Flag_experiment_status>("status", Status);
