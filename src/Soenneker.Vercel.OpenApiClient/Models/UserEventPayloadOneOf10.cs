...
namespace Soenneker.Vercel.OpenApiClient.Models
{
    ...
    public partial class UserEventPayloadOneOf10 : IAdditionalDataHolder, IParsable
    {
        ...
        public global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf10FromPlan? FromPlan { get; set; }
        /// <summary>Present on new events only. Equivalent to &quot;stripe&quot; when absent.</summary>
        public global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf10Provider? Provider { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf10ToPlan? ToPlan { get; set; }
        /// <summary>
        ...
        /// </summary>
        public UserEventPayloadOneOf10()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf10"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf10 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf10();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "fromPlan", n => { FromPlan = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf10FromPlan>(); } },
                ...
                { "toPlan", n => { ToPlan = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf10ToPlan>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf10FromPlan>("fromPlan", FromPlan);
            ...
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf10ToPlan>("toPlan", ToPlan);
