...
namespace Soenneker.Vercel.OpenApiClient.Models
{
    ...
    public partial class RemoveCustomEnvironment200_domains : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Vercel.OpenApiClient.Models.RemoveCustomEnvironment200_domains_verification>? Verification { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Vercel.OpenApiClient.Models.RemoveCustomEnvironment200_domains_verification> Verification { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Vercel.OpenApiClient.Models.RemoveCustomEnvironment200_domains"/> and sets the default values.
        /// </summary>
        public RemoveCustomEnvironment200_domains()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.Models.RemoveCustomEnvironment200_domains"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Vercel.OpenApiClient.Models.RemoveCustomEnvironment200_domains CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.Models.RemoveCustomEnvironment200_domains();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "verification", n => { Verification = n.GetCollectionOfObjectValues<global::Soenneker.Vercel.OpenApiClient.Models.RemoveCustomEnvironment200_domains_verification>(global::Soenneker.Vercel.OpenApiClient.Models.RemoveCustomEnvironment200_domains_verification.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Vercel.OpenApiClient.Models.RemoveCustomEnvironment200_domains_verification>("verification", Verification);
