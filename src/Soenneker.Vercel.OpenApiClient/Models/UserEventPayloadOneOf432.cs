...
namespace Soenneker.Vercel.OpenApiClient.Models
{
    ...
    public partial class UserEventPayloadOneOf432 : IAdditionalDataHolder, IParsable
    {
...
#nullable enable
        public global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf432Geolocation? Geolocation { get; set; }
#nullable restore
#else
        public global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf432Geolocation Geolocation { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf432Origin? Origin { get; set; }
...
#endif
        /// <summary>Present when `scope` is `&apos;project&apos;`.</summary>
        public global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf432ProjectScope? ProjectScope { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf432"/> and sets the default values.
        /// </summary>
        public UserEventPayloadOneOf432()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf432"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf432 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf432();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "geolocation", n => { Geolocation = n.GetObjectValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf432Geolocation>(global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf432Geolocation.CreateFromDiscriminatorValue); } },
                { "hasAuthorizationDetails", n => { HasAuthorizationDetails = n.GetBoolValue(); } },
                { "ip", n => { Ip = n.GetStringValue(); } },
                { "origin", n => { Origin = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf432Origin>(); } },
                { "projectId", n => { ProjectId = n.GetStringValue(); } },
                { "projectScope", n => { ProjectScope = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf432ProjectScope>(); } },
                { "reqId", n => { ReqId = n.GetStringValue(); } },
                { "reqUrl", n => { ReqUrl = n.GetStringValue(); } },
                { "scope", n => { Scope = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf432Scope>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf432Geolocation>("geolocation", Geolocation);
            writer.WriteBoolValue("hasAuthorizationDetails", HasAuthorizationDetails);
            writer.WriteStringValue("ip", Ip);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf432Origin>("origin", Origin);
            writer.WriteStringValue("projectId", ProjectId);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf432ProjectScope>("projectScope", ProjectScope);
            writer.WriteStringValue("reqId", ReqId);
            writer.WriteStringValue("reqUrl", ReqUrl);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf432Scope>("scope", Scope);
