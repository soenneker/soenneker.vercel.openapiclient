...
namespace Soenneker.Vercel.OpenApiClient.Models
{
    ...
    public partial class GetProjectDomain200 : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Vercel.OpenApiClient.Models.GetProjectDomain200_verification>? Verification { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Vercel.OpenApiClient.Models.GetProjectDomain200_verification> Verification { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Vercel.OpenApiClient.Models.GetProjectDomain200"/> and sets the default values.
        /// </summary>
        public GetProjectDomain200()
        {
        ...
        public static global::Soenneker.Vercel.OpenApiClient.Models.GetProjectDomain200 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.Models.GetProjectDomain200();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "verification", n => { Verification = n.GetCollectionOfObjectValues<global::Soenneker.Vercel.OpenApiClient.Models.GetProjectDomain200_verification>(global::Soenneker.Vercel.OpenApiClient.Models.GetProjectDomain200_verification.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Vercel.OpenApiClient.Models.GetProjectDomain200_verification>("verification", Verification);
