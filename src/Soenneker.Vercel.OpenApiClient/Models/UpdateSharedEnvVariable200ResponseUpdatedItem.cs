...
namespace Soenneker.Vercel.OpenApiClient.Models
{
    ...
    public partial class UpdateSharedEnvVariable200ResponseUpdatedItem : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Vercel.OpenApiClient.Models.UpdateSharedEnvVariable200ResponseUpdatedItemLastEditedByPrincipal? LastEditedByPrincipal { get; set; }
#nullable restore
#else
        public global::Soenneker.Vercel.OpenApiClient.Models.UpdateSharedEnvVariable200ResponseUpdatedItemLastEditedByPrincipal LastEditedByPrincipal { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Vercel.OpenApiClient.Models.UpdateSharedEnvVariable200ResponseUpdatedItemTargetItem?>? Target { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Vercel.OpenApiClient.Models.UpdateSharedEnvVariable200ResponseUpdatedItemTargetItem?> Target { get; set; }
#endif
        /// <summary>The type of this cosmos doc instance, if blank, assume secret.</summary>
        public global::Soenneker.Vercel.OpenApiClient.Models.UpdateSharedEnvVariable200ResponseUpdatedItemType? Type { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Vercel.OpenApiClient.Models.UpdateSharedEnvVariable200ResponseUpdatedItem"/> and sets the default values.
        /// </summary>
        public UpdateSharedEnvVariable200ResponseUpdatedItem()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.Models.UpdateSharedEnvVariable200ResponseUpdatedItem"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Vercel.OpenApiClient.Models.UpdateSharedEnvVariable200ResponseUpdatedItem CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.Models.UpdateSharedEnvVariable200ResponseUpdatedItem();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "lastEditedByPrincipal", n => { LastEditedByPrincipal = n.GetObjectValue<global::Soenneker.Vercel.OpenApiClient.Models.UpdateSharedEnvVariable200ResponseUpdatedItemLastEditedByPrincipal>(global::Soenneker.Vercel.OpenApiClient.Models.UpdateSharedEnvVariable200ResponseUpdatedItemLastEditedByPrincipal.CreateFromDiscriminatorValue); } },
                { "ownerId", n => { OwnerId = n.GetStringValue(); } },
                { "projectId", n => { ProjectId = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "target", n => { Target = n.GetCollectionOfEnumValues<global::Soenneker.Vercel.OpenApiClient.Models.UpdateSharedEnvVariable200ResponseUpdatedItemTargetItem>()?.AsList(); } },
                { "type", n => { Type = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UpdateSharedEnvVariable200ResponseUpdatedItemType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Vercel.OpenApiClient.Models.UpdateSharedEnvVariable200ResponseUpdatedItemLastEditedByPrincipal>("lastEditedByPrincipal", LastEditedByPrincipal);
            writer.WriteStringValue("ownerId", OwnerId);
            writer.WriteCollectionOfPrimitiveValues<string>("projectId", ProjectId);
            writer.WriteCollectionOfEnumValues<global::Soenneker.Vercel.OpenApiClient.Models.UpdateSharedEnvVariable200ResponseUpdatedItemTargetItem>("target", Target);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UpdateSharedEnvVariable200ResponseUpdatedItemType>("type", Type);
