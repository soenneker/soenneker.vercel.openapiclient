...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf174QueriesItem>? Queries { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf174QueriesItem> Queries { get; set; }
#endif
        ...
        public global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf174QueryType? QueryType { get; set; }
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "queries", n => { Queries = n.GetCollectionOfObjectValues<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf174QueriesItem>(global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf174QueriesItem.CreateFromDiscriminatorValue)?.AsList(); } },
                { "queryCount", n => { QueryCount = n.GetDoubleValue(); } },
                { "queryType", n => { QueryType = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf174QueryType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf174QueriesItem>("queries", Queries);
            writer.WriteDoubleValue("queryCount", QueryCount);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf174QueryType>("queryType", QueryType);
