...
namespace Soenneker.Vercel.OpenApiClient.Models
{
    ...
    public partial class TeamResourceConfigBuildMachine : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        public TeamResourceConfigBuildMachine()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.Models.TeamResourceConfigBuildMachine"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Vercel.OpenApiClient.Models.TeamResourceConfigBuildMachine CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.Models.TeamResourceConfigBuildMachine();
        }
        /// <summary>
