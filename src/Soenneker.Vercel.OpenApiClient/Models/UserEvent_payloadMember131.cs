...
namespace Soenneker.Vercel.OpenApiClient.Models
{
    ...
    public partial class UserEvent_payloadMember131 : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Vercel.OpenApiClient.Models.UserEvent_payloadMember131_queries>? Queries { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Vercel.OpenApiClient.Models.UserEvent_payloadMember131_queries> Queries { get; set; }
#endif
        ...
        public global::Soenneker.Vercel.OpenApiClient.Models.UserEvent_payloadMember131_queryType? QueryType { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Vercel.OpenApiClient.Models.UserEvent_payloadMember131"/> and sets the default values.
        /// </summary>
        public UserEvent_payloadMember131()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.Models.UserEvent_payloadMember131"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Vercel.OpenApiClient.Models.UserEvent_payloadMember131 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.Models.UserEvent_payloadMember131();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "queries", n => { Queries = n.GetCollectionOfObjectValues<global::Soenneker.Vercel.OpenApiClient.Models.UserEvent_payloadMember131_queries>(global::Soenneker.Vercel.OpenApiClient.Models.UserEvent_payloadMember131_queries.CreateFromDiscriminatorValue)?.AsList(); } },
                { "queryCount", n => { QueryCount = n.GetDoubleValue(); } },
                { "queryType", n => { QueryType = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEvent_payloadMember131_queryType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Vercel.OpenApiClient.Models.UserEvent_payloadMember131_queries>("queries", Queries);
            writer.WriteDoubleValue("queryCount", QueryCount);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEvent_payloadMember131_queryType>("queryType", QueryType);
