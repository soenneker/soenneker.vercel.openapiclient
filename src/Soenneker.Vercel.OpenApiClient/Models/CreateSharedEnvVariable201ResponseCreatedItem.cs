...
namespace Soenneker.Vercel.OpenApiClient.Models
{
    ...
    public partial class CreateSharedEnvVariable201ResponseCreatedItem : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Vercel.OpenApiClient.Models.CreateSharedEnvVariable201ResponseCreatedItemLastEditedByPrincipal? LastEditedByPrincipal { get; set; }
#nullable restore
#else
        public global::Soenneker.Vercel.OpenApiClient.Models.CreateSharedEnvVariable201ResponseCreatedItemLastEditedByPrincipal LastEditedByPrincipal { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Vercel.OpenApiClient.Models.CreateSharedEnvVariable201ResponseCreatedItemTargetItem?>? Target { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Vercel.OpenApiClient.Models.CreateSharedEnvVariable201ResponseCreatedItemTargetItem?> Target { get; set; }
#endif
        /// <summary>The type of this cosmos doc instance, if blank, assume secret.</summary>
        public global::Soenneker.Vercel.OpenApiClient.Models.CreateSharedEnvVariable201ResponseCreatedItemType? Type { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Vercel.OpenApiClient.Models.CreateSharedEnvVariable201ResponseCreatedItem"/> and sets the default values.
        /// </summary>
        public CreateSharedEnvVariable201ResponseCreatedItem()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.Models.CreateSharedEnvVariable201ResponseCreatedItem"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Vercel.OpenApiClient.Models.CreateSharedEnvVariable201ResponseCreatedItem CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.Models.CreateSharedEnvVariable201ResponseCreatedItem();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "lastEditedByPrincipal", n => { LastEditedByPrincipal = n.GetObjectValue<global::Soenneker.Vercel.OpenApiClient.Models.CreateSharedEnvVariable201ResponseCreatedItemLastEditedByPrincipal>(global::Soenneker.Vercel.OpenApiClient.Models.CreateSharedEnvVariable201ResponseCreatedItemLastEditedByPrincipal.CreateFromDiscriminatorValue); } },
                { "ownerId", n => { OwnerId = n.GetStringValue(); } },
                { "projectId", n => { ProjectId = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "target", n => { Target = n.GetCollectionOfEnumValues<global::Soenneker.Vercel.OpenApiClient.Models.CreateSharedEnvVariable201ResponseCreatedItemTargetItem>()?.AsList(); } },
                { "type", n => { Type = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.CreateSharedEnvVariable201ResponseCreatedItemType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Vercel.OpenApiClient.Models.CreateSharedEnvVariable201ResponseCreatedItemLastEditedByPrincipal>("lastEditedByPrincipal", LastEditedByPrincipal);
            writer.WriteStringValue("ownerId", OwnerId);
            writer.WriteCollectionOfPrimitiveValues<string>("projectId", ProjectId);
            writer.WriteCollectionOfEnumValues<global::Soenneker.Vercel.OpenApiClient.Models.CreateSharedEnvVariable201ResponseCreatedItemTargetItem>("target", Target);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.CreateSharedEnvVariable201ResponseCreatedItemType>("type", Type);
