...
namespace Soenneker.Vercel.OpenApiClient.Models
{
    ...
    public partial class ContactVerified : IParsable
    {
        ...
        public static global::Soenneker.Vercel.OpenApiClient.Models.ContactVerified CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.Models.ContactVerified();
        }
        /// <summary>
