...
#nullable restore
        ...
        public global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf440Origin? Origin { get; set; }
...
#endif
        /// <summary>Present when `scope` is `&apos;project&apos;`.</summary>
        public global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf440ProjectScope? ProjectScope { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf440Scope? Scope { get; set; }
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "origin", n => { Origin = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf440Origin>(); } },
                { "projectId", n => { ProjectId = n.GetStringValue(); } },
                { "projectScope", n => { ProjectScope = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf440ProjectScope>(); } },
                { "reqId", n => { ReqId = n.GetStringValue(); } },
                { "reqUrl", n => { ReqUrl = n.GetStringValue(); } },
                { "scope", n => { Scope = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf440Scope>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf440Origin>("origin", Origin);
            writer.WriteStringValue("projectId", ProjectId);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf440ProjectScope>("projectScope", ProjectScope);
            writer.WriteStringValue("reqId", ReqId);
            writer.WriteStringValue("reqUrl", ReqUrl);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.Models.UserEventPayloadOneOf440Scope>("scope", Scope);
