...
namespace Soenneker.Vercel.OpenApiClient.Models
{
    ...
    public partial class DangerouslyDeleteBySrcImages : IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.Models.DangerouslyDeleteBySrcImages"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Vercel.OpenApiClient.Models.DangerouslyDeleteBySrcImages CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.Models.DangerouslyDeleteBySrcImages();
        }
        /// <summary>
