...
#nullable enable
        public async Task<global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainItemRequestBuilder.WithDomainPatchResponse?> PatchAsWithDomainPatchResponseAsync(global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainItemRequestBuilder.WithDomainPatchRequestBody body, Action<RequestConfiguration<global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainItemRequestBuilder.WithDomainItemRequestBuilderPatchQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainItemRequestBuilder.WithDomainPatchResponse> PatchAsWithDomainPatchResponseAsync(global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainItemRequestBuilder.WithDomainPatchRequestBody body, Action<RequestConfiguration<global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainItemRequestBuilder.WithDomainItemRequestBuilderPatchQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        ...
        /// Update or move apex domain. Note: This endpoint is no longer used for updating auto-renew or nameservers. For this, please use the endpoints [Update auto-renew for a domain](https://vercel.com/docs/rest-api/reference/endpoints/domains-registrar/update-auto-renew-for-a-domain) and [Update nameservers for a domain](https://vercel.com/docs/rest-api/reference/endpoints/domains-registrar/update-nameservers-for-a-domain).
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainItemRequestBuilder.WithDomainResponse"/></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainItemRequestBuilder.WithDomainResponse?> PatchAsync(global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainItemRequestBuilder.WithDomainPatchRequestBody body, Action<RequestConfiguration<global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainItemRequestBuilder.WithDomainItemRequestBuilderPatchQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainItemRequestBuilder.WithDomainResponse> PatchAsync(global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainItemRequestBuilder.WithDomainPatchRequestBody body, Action<RequestConfiguration<global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainItemRequestBuilder.WithDomainItemRequestBuilderPatchQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            if(ReferenceEquals(body, null)) throw new ArgumentNullException(nameof(body));
            var requestInfo = ToPatchRequestInformation(body, requestConfiguration);
            return await RequestAdapter.SendAsync<global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainItemRequestBuilder.WithDomainResponse>(requestInfo, global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainItemRequestBuilder.WithDomainResponse.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Update or move apex domain. Note: This endpoint is no longer used for updating auto-renew or nameservers. For this, please use the endpoints [Update auto-renew for a domain](https://vercel.com/docs/rest-api/reference/endpoints/domains-registrar/update-auto-renew-for-a-domain) and [Update nameservers for a domain](https://vercel.com/docs/rest-api/reference/endpoints/domains-registrar/update-nameservers-for-a-domain).
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class WithDomainItemRequestBuilderPatchRequestConfiguration : RequestConfiguration<global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainItemRequestBuilder.WithDomainItemRequestBuilderPatchQueryParameters>
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class WithDomainResponse : IComposedTypeWrapper, IParsable
        {
            /// <summary>Composed type representation for type <see cref="global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainPatchResponseMember1"/></summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
            ...
            /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainItemRequestBuilder.WithDomainResponse"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainItemRequestBuilder.WithDomainResponse CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
                var result = new global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainItemRequestBuilder.WithDomainResponse();
                if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase))
                {
                    result.WithDomainPatchResponseMember1 = new global::Soenneker.Vercel.OpenApiClient.V3.Domains.Item.WithDomainPatchResponseMember1();
                }
