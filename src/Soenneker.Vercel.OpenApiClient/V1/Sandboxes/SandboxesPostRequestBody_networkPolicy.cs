...
namespace Soenneker.Vercel.OpenApiClient.V1.Sandboxes
{
    ...
    public partial class SandboxesPostRequestBody_networkPolicy : IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.SandboxesPostRequestBody_networkPolicy_injectionRules>? InjectionRules { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.SandboxesPostRequestBody_networkPolicy_injectionRules> InjectionRules { get; set; }
#endif
        ...
        public global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.SandboxesPostRequestBody_networkPolicy_mode? Mode { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.SandboxesPostRequestBody_networkPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.SandboxesPostRequestBody_networkPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.SandboxesPostRequestBody_networkPolicy();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "injectionRules", n => { InjectionRules = n.GetCollectionOfObjectValues<global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.SandboxesPostRequestBody_networkPolicy_injectionRules>(global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.SandboxesPostRequestBody_networkPolicy_injectionRules.CreateFromDiscriminatorValue)?.AsList(); } },
                { "mode", n => { Mode = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.SandboxesPostRequestBody_networkPolicy_mode>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.SandboxesPostRequestBody_networkPolicy_injectionRules>("injectionRules", InjectionRules);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.SandboxesPostRequestBody_networkPolicy_mode>("mode", Mode);
        }
    }
}
