...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.Item.NetworkPolicy.NetworkPolicyPostRequestBody_injectionRules>? InjectionRules { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.Item.NetworkPolicy.NetworkPolicyPostRequestBody_injectionRules> InjectionRules { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.Item.NetworkPolicy.NetworkPolicyPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.Item.NetworkPolicy.NetworkPolicyPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.Item.NetworkPolicy.NetworkPolicyPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "injectionRules", n => { InjectionRules = n.GetCollectionOfObjectValues<global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.Item.NetworkPolicy.NetworkPolicyPostRequestBody_injectionRules>(global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.Item.NetworkPolicy.NetworkPolicyPostRequestBody_injectionRules.CreateFromDiscriminatorValue)?.AsList(); } },
                { "mode", n => { Mode = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.Item.NetworkPolicy.NetworkPolicyPostRequestBody_mode>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.Item.NetworkPolicy.NetworkPolicyPostRequestBody_injectionRules>("injectionRules", InjectionRules);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.V1.Sandboxes.Item.NetworkPolicy.NetworkPolicyPostRequestBody_mode>("mode", Mode);
        }
    }
}
