...
#nullable enable
        public async Task<global::Soenneker.Vercel.OpenApiClient.V1.Security.AttackMode.AttackModePostResponse?> PostAsAttackModePostResponseAsync(global::Soenneker.Vercel.OpenApiClient.V1.Security.AttackMode.AttackModeRequestBuilder.AttackModePostRequestBody body, Action<RequestConfiguration<global::Soenneker.Vercel.OpenApiClient.V1.Security.AttackMode.AttackModeRequestBuilder.AttackModeRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Vercel.OpenApiClient.V1.Security.AttackMode.AttackModePostResponse> PostAsAttackModePostResponseAsync(global::Soenneker.Vercel.OpenApiClient.V1.Security.AttackMode.AttackModeRequestBuilder.AttackModePostRequestBody body, Action<RequestConfiguration<global::Soenneker.Vercel.OpenApiClient.V1.Security.AttackMode.AttackModeRequestBuilder.AttackModeRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        ...
        /// Update the setting for determining if the project has Attack Challenge mode enabled.
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.V1.Security.AttackMode.AttackModeResponse"/></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        [Obsolete("This method is obsolete. Use PostAsAttackModePostResponseAsync instead.")]
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Vercel.OpenApiClient.V1.Security.AttackMode.AttackModeResponse?> PostAsync(global::Soenneker.Vercel.OpenApiClient.V1.Security.AttackMode.AttackModeRequestBuilder.AttackModePostRequestBody body, Action<RequestConfiguration<global::Soenneker.Vercel.OpenApiClient.V1.Security.AttackMode.AttackModeRequestBuilder.AttackModeRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Vercel.OpenApiClient.V1.Security.AttackMode.AttackModeResponse> PostAsync(global::Soenneker.Vercel.OpenApiClient.V1.Security.AttackMode.AttackModeRequestBuilder.AttackModePostRequestBody body, Action<RequestConfiguration<global::Soenneker.Vercel.OpenApiClient.V1.Security.AttackMode.AttackModeRequestBuilder.AttackModeRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            if(ReferenceEquals(body, null)) throw new ArgumentNullException(nameof(body));
            var requestInfo = ToPostRequestInformation(body, requestConfiguration);
            return await RequestAdapter.SendAsync<global::Soenneker.Vercel.OpenApiClient.V1.Security.AttackMode.AttackModeResponse>(requestInfo, global::Soenneker.Vercel.OpenApiClient.V1.Security.AttackMode.AttackModeResponse.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Update the setting for determining if the project has Attack Challenge mode enabled.
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class AttackModeRequestBuilderPostRequestConfiguration : RequestConfiguration<global::Soenneker.Vercel.OpenApiClient.V1.Security.AttackMode.AttackModeRequestBuilder.AttackModeRequestBuilderPostQueryParameters>
        {
        }
    }
}
