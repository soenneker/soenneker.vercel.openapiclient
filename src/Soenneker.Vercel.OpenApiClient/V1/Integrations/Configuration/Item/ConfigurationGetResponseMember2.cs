...
namespace Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item
{
    ...
    public partial class ConfigurationGetResponseMember2 : IAdditionalDataHolder, IParsable
    {
        ...
        public global::Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item.ConfigurationGetResponseMember2_disabledReason? DisabledReason { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item.ConfigurationGetResponseMember2_installationType? InstallationType { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item.ConfigurationGetResponseMember2_source? Source { get; set; }
        /// <summary>The configuration status. Optional. If not defined, assume &apos;ready&apos;.</summary>
        public global::Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item.ConfigurationGetResponseMember2_status? Status { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item.ConfigurationGetResponseMember2_type? Type { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item.ConfigurationGetResponseMember2"/> and sets the default values.
        /// </summary>
        public ConfigurationGetResponseMember2()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item.ConfigurationGetResponseMember2"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item.ConfigurationGetResponseMember2 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item.ConfigurationGetResponseMember2();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "disabledReason", n => { DisabledReason = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item.ConfigurationGetResponseMember2_disabledReason>(); } },
                { "externalId", n => { ExternalId = n.GetStringValue(); } },
                { "id", n => { Id = n.GetStringValue(); } },
                { "installationType", n => { InstallationType = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item.ConfigurationGetResponseMember2_installationType>(); } },
                ...
                { "source", n => { Source = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item.ConfigurationGetResponseMember2_source>(); } },
                { "status", n => { Status = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item.ConfigurationGetResponseMember2_status>(); } },
                { "teamId", n => { TeamId = n.GetStringValue(); } },
                { "type", n => { Type = n.GetEnumValue<global::Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item.ConfigurationGetResponseMember2_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item.ConfigurationGetResponseMember2_disabledReason>("disabledReason", DisabledReason);
            writer.WriteStringValue("externalId", ExternalId);
            writer.WriteStringValue("id", Id);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item.ConfigurationGetResponseMember2_installationType>("installationType", InstallationType);
            ...
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item.ConfigurationGetResponseMember2_source>("source", Source);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item.ConfigurationGetResponseMember2_status>("status", Status);
            writer.WriteStringValue("teamId", TeamId);
            writer.WriteEnumValue<global::Soenneker.Vercel.OpenApiClient.V1.Integrations.Configuration.Item.ConfigurationGetResponseMember2_type>("type", Type);
