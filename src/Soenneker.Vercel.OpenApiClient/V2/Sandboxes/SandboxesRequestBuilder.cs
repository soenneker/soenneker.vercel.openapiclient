...
namespace Soenneker.Vercel.OpenApiClient.V2.Sandboxes
{
    ...
    public partial class SandboxesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.Models.ListNamedSandboxes200Response"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Vercel.OpenApiClient.Models.ListNamedSandboxes200Response?> GetAsync(Action<RequestConfiguration<global::Soenneker.Vercel.OpenApiClient.V2.Sandboxes.SandboxesRequestBuilder.SandboxesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Vercel.OpenApiClient.Models.ListNamedSandboxes200Response> GetAsync(Action<RequestConfiguration<global::Soenneker.Vercel.OpenApiClient.V2.Sandboxes.SandboxesRequestBuilder.SandboxesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Vercel.OpenApiClient.Models.ListNamedSandboxes200Response>(requestInfo, global::Soenneker.Vercel.OpenApiClient.Models.ListNamedSandboxes200Response.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.Models.CreateSandboxesV2200Response"/></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Vercel.OpenApiClient.Models.CreateSandboxesV2200Response?> PostAsync(global::Soenneker.Vercel.OpenApiClient.Models.CreateSandboxesV2Request body, Action<RequestConfiguration<global::Soenneker.Vercel.OpenApiClient.V2.Sandboxes.SandboxesRequestBuilder.SandboxesRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Vercel.OpenApiClient.Models.CreateSandboxesV2200Response> PostAsync(global::Soenneker.Vercel.OpenApiClient.Models.CreateSandboxesV2Request body, Action<RequestConfiguration<global::Soenneker.Vercel.OpenApiClient.V2.Sandboxes.SandboxesRequestBuilder.SandboxesRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Vercel.OpenApiClient.Models.CreateSandboxesV2Request body, Action<RequestConfiguration<global::Soenneker.Vercel.OpenApiClient.V2.Sandboxes.SandboxesRequestBuilder.SandboxesRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Vercel.OpenApiClient.Models.CreateSandboxesV2Request body, Action<RequestConfiguration<global::Soenneker.Vercel.OpenApiClient.V2.Sandboxes.SandboxesRequestBuilder.SandboxesRequestBuilderPostQueryParameters>> requestConfiguration = default)
...
#nullable restore
            ...
            public global::Soenneker.Vercel.OpenApiClient.Models.ListNamedSandboxesSortByParameter? SortBy { get; set; }
            /// <summary>Sort direction. Defaults to desc.</summary>
            [QueryParameter("sortOrder")]
            public global::Soenneker.Vercel.OpenApiClient.Models.ListNamedSandboxesSortOrderParameter? SortOrder { get; set; }
            /// <summary>Filter named sandboxes by status. Only valid when sortBy is createdAt.</summary>
            [QueryParameter("status")]
            public global::Soenneker.Vercel.OpenApiClient.Models.ListNamedSandboxesStatusParameter? Status { get; set; }
