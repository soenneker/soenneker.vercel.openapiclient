...
namespace Soenneker.Vercel.OpenApiClient.V11.Projects
{
    ...
    public partial class ProjectsPostResponse_usageStatus : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        public ProjectsPostResponse_usageStatus()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.V11.Projects.ProjectsPostResponse_usageStatus"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Vercel.OpenApiClient.V11.Projects.ProjectsPostResponse_usageStatus CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.V11.Projects.ProjectsPostResponse_usageStatus();
        }
        /// <summary>
