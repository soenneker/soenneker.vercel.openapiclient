...
namespace Soenneker.Vercel.OpenApiClient.Sandboxes.Item
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Vercel.OpenApiClient.Sandboxes.Item.WithNamePatchRequestBody_keepLastSnapshotsMember1"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Vercel.OpenApiClient.Sandboxes.Item.WithNamePatchRequestBody_keepLastSnapshotsMember1 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Vercel.OpenApiClient.Sandboxes.Item.WithNamePatchRequestBody_keepLastSnapshotsMember1();
        }
        /// <summary>
